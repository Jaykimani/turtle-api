const content = [
    ...
    },
    {
        ...
        ingredients : ["Blueberries", "Banana", "Rolled oats", "Spinach", "Milk of choice"],
        description : "Blueberries aren't just bursting with flavor, they also boast a vibrant array of ANTIOXIDANTS that can help protect your cells from damage. Spinach contribute a significant dose of essential VITAMINS and MINERALS that your body craves to function optimally. Oats provide complex CARBOHYDRATES for sustained energy. These complex carbs won't cause a blood sugar spike, keeping you feeling fuller for longer and reducing the urge to reach for unhealthy snacks. Banana adds a touch of natural sweetness and POTASSIUM, a key electrolyte that helps maintain proper fluid balance. Finally, your choice of milk, dairy or plant based, offers a protein and calcium boost to round out this comprehensive nutritional profile.",
        pricing : [250.00,  350.00, 450.00],
    ...
    },
    {
        ...
        color : `rgb(204, 0 , 255)`,
        font : `'Protest Riot', sans-serif`,
        ingredients : ["Banana", "Mango", "Pineapple", "Spinach", "Water"],
        description : "Bananas are a natural source of POTASSIUM, essential for proper muscle function and heart health. Meanwhile, Mangoes and Pineapples are bursting with VITAMIN C, which strengthens your immune system and gives your metabolism a natural boost. Spinach adds a hidden punch of leafy green goodness, sneaking in VITAMINS A and K for healthy vision and blood clotting. Don't underestimate the power of FIBER! All these ingredients are packed with it, keeping you feeling fuller for longer and aiding in appetite control. Plus, water is the ultimate zero-calorie hydrator, crucial for feeling satisfied and burning calories efficiently.",
        pricing : [250.00,  350.00, 450.00],
        type : 'Weight-loss smoothie'
    },
    {
        ...
        color : `rgb(235, 255 , 0)`,
        font : `'Protest Riot', sans-serif`,
        ingredients : ["Banana", "Peanut butter", "Cacao powder", "Milk of choice", "Cinnamon"],
        description : "Bananas provide a natural source of POTASSIUM for sustained energy, while Peanut butter offers a satisfying combination of PROTEIN and HEALTHY FATS to keep you feeling satiated for longer. Cravings don't stand a chance! Cacao powder, with its rich chocolatey flavor, boasts mood-boosting MAGNESIUM and ANTIOXIDANTS that fight free radicals, protecting your cells and overall health. The milk of your choice, whether dairy or plant-based, provides essential CALCIUM for strong bones and VITAMIN D to aid in nutrient absorption. A sprinkle of cinnamon adds to the health benefits, by helping regulate blood sugar, preventing energy crashes that can often lead to unhealthy snacking choices.",
        pricing : [250.00,  350.00, 450.00],
        type : 'Weight-loss smoothie'
    },
    {
        id : 44,
        name : "PINEBERRY GINGER",
        color : `rgb(5, 226 , 27)`,
        font : `'Protest Riot', sans-serif`,
        ingredients : ["Pineapple", "Strawberries", "Spinach", "Chia seeds", "Ginger", "Milk of choice"],
        description : "Pineapple and Strawberries create a tropical taste explosion while providing a hefty dose of VITAMIN C. This essential nutrient acts like a double agent, boosting your immune system to fight off illness and giving your metabolism a natural nudge. Spinach adds a hidden layer of VITAMINS A and K, both crucial for healthy vision and blood clotting. But the true champions are the unassuming Chia seeds and your chosen milk. Chia seeds are nature's tiny titans of FIBER. They soak up liquid and expand in your stomach, keeping you feeling fuller for longer and curbing cravings. Milk, whether dairy-based or a plant-powered alternative, provides a PROTEIN punch that further enhances satiety and supports strong bones.",
        pricing : [250.00,  350.00, 450.00],
        type : 'Weight-loss smoothie'
    },
    {
        ...
        color : `rgb(36, 255 , 0)`,
        font : `'Protest Riot', sans-serif`,
        ingredients : ["Green apples", "Spinach", "Avocado", "Cucumber", "Lemon", "Ginger"],
        description : "Apple and Cucumber offer a refreshing duo of low-calorie hydration, keeping you feeling full without weighing you down.  Spinach sneaks in essential VITAMINS A and K for healthy vision and blood clotting. The creamy avocado, with its HEALTHY FATS, is a champion for satiety. It keeps you feeling fuller for longer, reducing cravings and aiding in appetite control. Ginger, a natural ANTI-INFLAMMATORY, plays a double role. It can help regulate blood sugar, preventing those energy crashes that can lead to unhealthy snacking, and improve digestion, ensuring your body efficiently absorbs nutrients. Finally, a squeeze of lemon adds a touch of VITAMIN C, which not only boosts your immune system but also gives your metabolism a natural lift.",
        pricing : [250.00,  350.00, 450.00],
        type : 'Weight-loss smoothie'
    },
    {
        ...
        color : `rgb(203, 0 , 134)`,
        font : `'Protest Riot', sans-serif`,
        ingredients : ["Pineapple", "Mango", "Banana", "Turmeric powder", "Milk of choice", "Lemon"],
        description : "Pineapple, mango, and banana create a flavor fiesta rich in vitamins and fiber. VITAMIN C from these fruits strengthens your immune system and gives your metabolism a natural boost, while FIBER keeps you feeling fuller for longer, reducing cravings and aiding in appetite control. Turmeric powder, a vibrant ANTI-INFLAMMATORY spice, boasts CURCUMIN, a compound known to aid in digestion and potentially even fat burning. Milk, whether dairy or plant-based, provides essential PROTEIN and CALCIUM for strong bones and muscle function. A squeeze of lemon adds another dimension of health benefits. Not only does it enhance the flavor, but it also provides a dose of VITAMIN C for a further metabolic boost.",
        pricing : [250.00,  350.00, 450.00],
        type : 'Weight-loss smoothie'
    },
    {
        ...
        color : `rgb(254, 47 , 47)`,
        font : `'Protest Riot', sans-serif`,
        ingredients : ["Banana", "Peanut butter", "Chia seeds", "Milk of choice", "Honey"],
        description : "Bananas provide a natural energy boost with POTASSIUM, while Peanut butter offers a delightful combination of PROTEIN and HEALTHY FATS. This keeps you feeling satiated for longer, preventing those mid-morning or afternoon hunger pangs that can derail your weight loss efforts. Chia seeds are tiny nutritional powerhouses bursting with FIBER. They absorb liquid in your stomach, creating a feeling of fullness and helping you manage portion control. Milk, whether dairy-based or plant-powered, adds a PROTEIN punch to further enhance satiety and support muscle health. A touch of honey provides sweetness without excessive sugar, and its natural properties can even aid in digestion.",
        pricing : [250.00,  350.00, 450.00],
        type : 'Weight-loss smoothie'
    },
    {
        ...
        font : `'Protest Riot', sans-serif`,
        ingredients : ["Pineapple", "Banana", "Avocado", "Spinach", "Water"],
        description : "Banana and pineapple provide a naturally sweet base and a hefty dose of VITAMIN C. This essential nutrient gives your immune system a fighting chance against illness while also giving your metabolism a natural nudge. Spinach, adds a hidden layer of essential VITAMINS A and K, crucial for healthy vision and blood clotting. Avocado boasts a unique blend of HEALTHY FATS that keep you feeling fuller for longer, reducing cravings and aiding in appetite control. This translates to fewer unnecessary calories consumed throughout the day and a reduced risk of unhealthy snacking.  Blended with water, this smoothie is naturally low in calories and keeps you hydrated, a key factor for burning calories efficiently.",
        pricing : [250.00,  350.00, 450.00],
        type : 'Weight-loss smoothie'
    },
    {
